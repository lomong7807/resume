...
export const companyProjects: CompanyProject[] = [
  {
    ...
    summary:
      '대학 고객사(약 30곳)에 납품하는 데이터센터 모니터링 웹입니다. 프로젝트를 리드하며 설계·개발, 배포 파이프라인, 개발 프로세스 정립을 맡았습니다.',
    work: [
  ...
  },
  {
    ...
    summary:
      '외주로 개발된 장비 상태 수집기(C)를 인수해 납품 가능한 수준으로 안정화했습니다. AI로 C 코드베이스를 분석해 직접 수정했습니다.',
    work: [
  ...
  {
    name: '서울기록원 기록관리시스템 고도화',
    org: '라인업코리아',
    start: '2026-02',
    end: null,
    summary:
      '2017년부터 운영된 약 20만 LOC 레거시 시스템(Spring Boot 1.5·Oracle)의 고도화를 담당했습니다. 담당자가 직접 조건·컬럼을 골라 엑셀로 내려받는 기록물 데이터 추출 기능(약 44만 건 규모)과 관계전거 승인 워크플로우를 개발했습니다.',
    work: [
      '조건 필터·계층 트리 추출 두 방식, 백그라운드 잡 큐 처리와 완료 알림',
      'Oracle CONNECT BY 워크테이블 전개, SXSSF 청크 방식 엑셀 생성',
      '추출 전용 스레드풀, 상한·동시 실행 제한 등 시스템 보호 장치',
      'CAS 기반 잡 상태 전이로 취소·실행 경합 제거',
      '관계전거 승인 워크플로우·헤더 알림 구현, 재사용 가능한 승인 구조',
    ],
    outcome: [
